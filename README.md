...
- Signs in to Dexcom Share using the selected EU/International or US server.
- Displays the latest glucose reading in mmol/L or mg/dL with trend direction and local reading time.
