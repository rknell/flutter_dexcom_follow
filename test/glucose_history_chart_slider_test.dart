...
void main() {
  testWidgets('🚀 FEATURE: slider limits visible points and preserves prediction', (tester) async {
    ...
    LineChartData chartData() => tester.widget<LineChart>(find.byType(LineChart)).data;
